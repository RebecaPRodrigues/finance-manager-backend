...
public record RegisterTransactionDTO(String userId, TransactionType type, Double amount, String transactionWith, 
        String description, LocalDate date, TransactionCategory category, String paymentMethod) {}
